...
class backup_qtype_splitset_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $splitset->set_source_table('question_splitset', array('questionid' => backup::VAR_PARENTID));

        $splitsetsub->set_source_table('question_splitset_sub', array('questionid' => backup::VAR_PARENTID));
